...
<head>
    ...
    <link rel="stylesheet" href="../styles/marcadas.css">
...
<?php
    ...
    if ($tipo ==  'Cliente') {
        ...
        $listaConsultas = $daoConsulta->listaPorIdClienteDiario($idUsuario);
                    ...
                    <div class="resumo">
                        ...
                        ?>
                            <div class="consulta">
                                ...
                                <div class="remarca-deleta-opcoes">

                              
                                <div class="remarca-deleta">
                                    <form class="form-remarca" action="remarcaConsulta.php" method="post">
                                        <input type="hidden" name="idCliente" id="idCliente" value="<?php echo $idUsuario; ?>">    
                                        <input type="hidden" name="idConsulta" id="idConsulta" value="<?php echo $consulta->getIdConsulta(); ?>">    
                                        <button type="submit" title="Remarcar">
                                            
                                        </button>
                                    </form>
                                    <form class="form-deleta" action="remarcaConsulta.php" method="post">
                                        <input type="hidden" name="idCliente" id="idCliente" value="<?php echo $idUsuario; ?>">    
                                        <input type="hidden" name="idConsulta" id="idConsulta" value="<?php echo $idUsuario; ?>">    

                                        <button type="submit" title="Desmarcar"> 
